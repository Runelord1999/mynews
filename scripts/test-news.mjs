...
import { parseFeed, safeUrl, summarise } from '../lib/news.ts';
...
console.log('PASS: RSS and Atom parsing, full-text content:encoded summaries capped at 250 words, original publisher links, and unsafe URL rejection.');
