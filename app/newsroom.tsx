...
import {defaults,safeUrl,allSources,sourceHost,matchTopic,topicQueryGroups,engines,engineIds,audiences,audienceAllows,blockedBy,type Topic,type Article,type NewsSite,type Audience} from '@/lib/news';
...
export default function Newsroom(){
 ...
 const feedKey=JSON.stringify({version:5,onlySites,maxAudience,removedSources,sources:[...sources].sort(),topics:topics.map(t=>[t.name,t.keywords]),sites:sites.map(s=>[s.url,s.feedUrl])});
